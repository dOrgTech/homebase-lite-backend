...
function parseSchema(counter, token, init, name) {
...
async function parseContractScript(c, initTokenTable = {}) {
    let token, counter = 0;
...
async function getContractEndpoints(network, contractAddress) {
    try {
